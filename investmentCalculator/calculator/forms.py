...
class InvestmentForm(forms.Form):
    ...
    monthly_contribution = forms.IntegerField(label='Monthly Contribution', min_value=0)
    annual_additional_contribution = forms.FloatField(label='Annual Additional Contribution', min_value=0, max_value=100)